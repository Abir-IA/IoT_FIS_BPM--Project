...
[num,txt,tab]=xlsread('eventdatasample1.xls');
...
%ScorePatient= typecast(str2double(scorePatient), 'double');
...
%k=[num2str(idev'),strvcat(cellstr(sour)),strvcat(cellstr(dte)),strvcat(cellstr(heuree)),num2str(inJ'),num2str(inLs'),num2str(nivCh'),num2str(durCht'),strvcat(cellstr(score)),num2str(frq'),num2str(chteur'),num2str(chte'),num2str(idniveau'),num2str(intervSemaine')]
 ...
 StatusInput=[idev', sour', inJ', inLs', nivCh', durCht', score', frq', chteur', chte', idniveau', intervSemaine']
% 
% 
% 
% str1=k(1,:);
...
InputDeviceTable = table(Position, ID_Device_Cam, Total_FalseAlerts_2015, Total_FalseAlerts_2016, Total_FalseAlerts_2017, Total_FalseAlerts_2018, Device_Changed);
...
%k2=strvcat([num2str(ID_Dev(i)); pos(i); num2str(Total_FalseAlerts15(i)); num2str(Total_FalseAlerts16(i)); num2str(Total_FalseAlerts17(i)); num2str(Total_FalseAlerts18(i)); num2str(DevChanged(i))]);


DeviceInput=[ID_Dev', pos', Total_FalseAlerts15', Total_FalseAlerts16', Total_FalseAlerts17', Total_FalseAlerts18', DevChanged']
